...
const Header: React.FC = () => {
  ...
  {profileOpen && (
    <div className="absolute right-0 mt-2 w-40 bg-white dark:bg-darklight border border-border dark:border-dark_border rounded-lg shadow-lg z-50">
      <button
        onClick={() => {
          logout();
          setProfileOpen(false);
        }}
        className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
      >
        Logout
      </button>
    </div>
